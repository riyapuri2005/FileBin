export const FileDisplay = ({ item }) => {
    return (
        <div onClick={() => window.open(`/api/download/${item.path}`)} className="flex justify-between items-center bg-green-50 hover:bg-green-100 shadow rounded-md p-4 transition cursor-pointer">
